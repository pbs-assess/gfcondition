...
# SEX AND MATURITY SPECIFIC INDICES OF BODY CONDITION {#app:condition}
...
<!-- Only include this next sentence when dens_model_name does include "only-sampled" -->
...
Indices of coastwide average `r species` body condition have been increasing for all maturity classes with the exception of 2019 when it dropped for all classes (Figure \@ref(fig:cond-indices)A). This drop was steepest among immatures, which reached their highest biomass for this time series in that year. However, it does not appear that density-dependence alone can explain this pattern, because mature fish biomass continues climbing while experiencing a similar rebound in body condition.
...
Splitting these indices by synoptic trawl survey area suggests that inter annual patterns in body condition differ a lot between regions of the coast (Figure \@ref(fig:cond-indices)B). 
Body condition plummets in WCVI and/or QCS in 2019 for all classes, but most steeply and with a quicker recovery among immatures.
