...
calc_condition_indices <- function(maturity, males, females, add_density) {
  ...
  dset <- readRDS(paste0("stock-specific/", spp, "/output/density-data-", spp, ".rds")) %>%
  ...
  # i2 <- paste0("stock-specific/", spp, "/output/cond-index/", model_name, "/survey-cond-indices-", spp, "-", group_tag, "-", model_name, "-", knot_distance, "-km.rds")
  #
  # if(!file.exists(i2)) {
  #
  ...
  #   labs(title = paste0(species, ": ", group_label, " ", "-", model_name))
  #
  # ggsave(paste0("stock-specific/", spp, "/figs/condition-index-", spp, "-split-", group_tag, "-", model_name, "-", knot_distance, "-km.png"),
  ...
  # saveRDS(p2, paste0("stock-specific/", spp, "/output/cond-predictions/", spp,
  #  "-pc", "-", group_tag, "-", model_name, "-", knot_distance, "-km.rds"))
  # saveRDS(ind2, paste0("stock-specific/", spp, "/output/cond-index/", model_name, "/", spp, "-pc",
  #  "-", group_tag, "-", model_name, "-", knot_distance, "-km.rds"))
