...
model_date <- "2025-07"
knot_distance <- "10" # current default for coastwide stocks
```
...
Surveys included for density estimation were the four contemporary Synoptic bottom trawl surveys (SYN) and 
two Small-mesh Multispecies Bottom Trawl Surveys (SMMS).
...
When individual weights were missing, but lengths were known, individuals were assigned estimated weights based on the overall average length-weight relationship (derived using Eq. \@ref(eq:lw-student)).
<!-- In past have refered to biological appendix of stock assessment, although could be added here too for completeness. -->
TODO: ADD length-weight relationship equation
